...
public static partial class RestEntityExtensions
{
    ...
    */
    ...
    public static IPagedEnumerable<IUser> EnumerateEventUsers(this IGuild guild,
        Snowflake eventId, int limit, FetchDirection direction = FetchDirection.After,
    ...
    public static Task<IReadOnlyList<IUser>> FetchEventUsersAsync(this IGuild guild,
        ...
        FetchDirection direction = FetchDirection.After, Snowflake? startFromId = null,
    ...
    {
        var client = guild.GetRestClient();
        return client.CreateAutoModerationRuleAsync(guild.Id, name, eventType, trigger, actions, action, options, cancellationToken);
    }
