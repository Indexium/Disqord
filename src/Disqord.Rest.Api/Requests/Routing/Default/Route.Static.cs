...
public sealed partial class Route
{
    ...
    {
        return new(HttpRequestMethod.Get, path);
    }

    public static Route Post(string path)
    {
        return new(HttpRequestMethod.Post, path);
    }

    public static Route Patch(string path)
    {
        return new(HttpRequestMethod.Patch, path);
    }

    public static Route Put(string path)
    {
        return new(HttpRequestMethod.Put, path);
    }

    public static Route Delete(string path)
    {
        return new(HttpRequestMethod.Delete, path);
    }
